...
const (
	...
	SERVER_CERT = "https://github.com/anik36/Golang/blob/advanced-go/advanced-go/SSL/server.crt"
	SERVER_KEY = "https://github.com/anik36/Golang/blob/advanced-go/advanced-go/SSL/server.key"
)
